...
highlight Comment           guifg=fg gui=italic 
highlight Todo              guifg=fg gui=none

highlight Constant          guifg=fg gui=bold 
highlight String            guifg=fg gui=none
highlight Number            guifg=fg gui=none

highlight Statement         guifg=fg gui=bold 
highlight Identifier        guifg=fg gui=none
highlight Function          guifg=fg gui=none
highlight Type              guifg=fg gui=bold 

highlight PreProc           guifg=fg gui=none

highlight Special           guifg=fg gui=italic 
highlight SpecialComment    guifg=fg gui=none
