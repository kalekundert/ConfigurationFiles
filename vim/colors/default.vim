...
" Likewise, choose light colors when the background is dark.
    ...
    highlight Comment           guifg=DarkGray   ctermfg=LightGray  cterm=none gui=italic 
    ...
    highlight SpellBad          guisp=DarkGray                      gui=undercurl
    highlight SpellCap          guisp=DarkGray                      gui=undercurl
    highlight SpellRare         guisp=DarkGray                      gui=undercurl
    highlight SpellLocal        guisp=DarkGray                      gui=undercurl
